function [F1,F2,phase2]=gf_50Hz(arquivo,num_periodos,Nfft)
...
%arquivo --> localização da gravação (pasta, diretório, subdiretório, etc)
%deltaf--> largura de faixa do filtro [Hz] 
%num_periodos --> tamanho da janela (número de ciclos da ENF nominal)
%Nfft --> número de pontos da DFT
